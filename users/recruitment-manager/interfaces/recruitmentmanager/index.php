...
<head>
    ...
    <link rel="stylesheet" href="./interfaces/recruitmentmanager/index.css">
...
<body>
    <div class="main-container">
        <div class="top-container" id="top-container">
            ...
            <div class="position">Recruitment Manager</div>
        ...
        <div class="side-container" id="side-container">
            ...
            <div class="buttons">
                ...
                <button class="dropButton"> Recruitment</button>
                <div class="drop-content">
                    <a href="index.php?Page=viewcandidate.php">Display Candidate Details</a>
                    <a href="index.php?Page=empjobsummary.php">Employee Job Summary</a>
                    <a href="index.php?Page=postvacancies.php">Post Vacancies</a>
                    <a href="index.php?Page=scheduleint.php">Schedule Interviews</a>
                    <a href="index.php?Page=addemployee.php">Add Employees</a>
        ...
        <div class="content" id="content">
            ...
            if (!empty($_GET["Page"])) {
                ...
                unset($pages_folder[5], $pages_folder[6], $pages_folder[9], $pages_folder[10]);
                // echo "<pre>";
                // print_r($pages_folder);
                // echo "</pre>";
