...
<head>
    ...
    <link rel="stylesheet" href="./interfaces/hrmanager/index.css">
    ...
    <div class="main-container">
        ...
        <div class="side-container" id="side-container">
            ...
            <div class="buttons">
                ...
                <button class="dropButton"> HR</button>
                <div class="drop-content">
                    <a href="index.php?Page=scheduletraining.php">Schedule Training</a>
                    <a href="index.php?Page=viewtraining.php">Training Details</a>
					<a href="index.php?Page=viewemployee.php">View Employee</a>
                    <a href="index.php?Page=updateemp.php">Update Employee</a>
                    <a href="index.php?Page=adddept.php">Add Department</a>
